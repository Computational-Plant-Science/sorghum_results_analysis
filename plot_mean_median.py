...
def plot_averages(df, stat_type='Mean', show_error=True, out_png=None):
    """
    ...
    - out_png (str): If specified, saves the plot to a PNG file instead of showing it.
    """
    if stat_type == 'Mean':
        df_avg = df.mean()
...
def main():
    ...
    parser.add_argument('--input', required=True, help='Cleaned Excel file')
